...
public class TelaParametrosReportUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaParametrosReportUsuario frame = new TelaParametrosReportUsuario();
	 ...
	 * Create the frame.
	 */
	public TelaParametrosReportUsuario() {
		...
		sairButton.setFont(new Font("Stencil", Font.PLAIN, 16));
		sairButton.setBackground(new Color(50, 0, 0));
		sairButton.setBounds(256, 190, 120, 23);
		...
		fundoLabel.setIcon(
				new ImageIcon(TelaParametrosReportUsuario.class.getResource("/assets/fundo com cerveja.jpeg")));
